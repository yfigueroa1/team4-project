...
class HomePage(Screen):
    def __init__(self, **kwargs):
        ...
        quantity_button = Button(
            ...
            size_hint=(None, None),
            size=(200, 40),
            pos_hint={'center_x': 0.5, 'center_y': 0.6}  # Adjust the vertical position
        )
        ...
        view_inventory_button = Button(
            ...
            size_hint=(None, None),
            size=(200, 40),
            pos_hint={'center_x': 0.5, 'center_y': 0.5}  # Adjust the vertical position
        )
        ...
        barcode_button = Button(
            ...
            size_hint=(None, None),
            size=(200, 40),
            pos_hint={'center_x': 0.5, 'center_y': 0.4}  # Adjust the vertical position
        )
...
class BarcodePage(Screen):
    def __init__(self, **kwargs):
        ...
        show_inventory_button = Button(
            ...
            size_hint=(None, None),
            size=(200, 40),
            pos_hint={'center_x': 0.5, 'center_y': 0.3}  # Adjust the vertical position
        )
